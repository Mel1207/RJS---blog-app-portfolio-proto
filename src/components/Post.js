    ...
    return (
        <main className="bg-green-100 min-h-screen p-12">
            <section className="container mx-auto">
                <h1 className="text-5xl">Blog Post Page</h1>
                <h2 className="text-lg mb-20">Welcome to my page of blog post</h2>
                            ...
                            <Link to={"/post/" + post.slug} key={post.slug}>
                                <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-green-400" key={index}>
                                    ...
                                    <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                        <h3 className="text-gray-800 text-lg px-3 py-4 bg-red-700 font-bold text-red-100 bg-opacity-75">{post.title}</h3>
                                    </span>
                                </span>
                            </Link>
                        </article>
